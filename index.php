...
<body>
 ...
 <nav class="navbar navbar-expand-sm navbar-dark bg-danger pl-5 fixed-top">
    <a href="index.php" class="navbar-brand">OMSS</a>
    <span class="navbar-text">Customer Satisfaction Is Our Passion</span>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/Banner1.jpeg);">
    <div class="myclass mainHeading">
      <h1 class="text-uppercase text-danger font-weight-bold">Welcome to OMSS</h1>
      <p class="font-italic text-white">Customer Satisfaction Is Our Passion</p>
  ...
  <div class="container">
    ...
    <div class="jumbotron">
      <h3 class="text-center">Online Maintanance Service System</h3>
      <p>
        OMSS Services is India’s leading chain of multi-brand Electronics and Electrical service
        workshops offering
    ...
    <div class="container">
      ...
      <div class="row mt-5">
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="images/avtar1.jpeg" class="img-fluid" style="border-radius: 80px;">
              <h4 class="card-title">Harshad Sinha</h4>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Rucha Sippy</h4>
              <p class="card-text">Itaque illo explicabo voluptatum, saepe libero rerum, ad ducimus voluptas nesciunt debitis numquam.</p>
            </div>
          </div>
        </div> 
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Jhon D'suza</h4>
              <p class="card-text">Itaque illo explicabo voluptatum, saepe libero rerum, ad ducimus voluptas nesciunt debitis numquam.</p>
            </div>
          </div>
        </div> 
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="images/avtar4.jpeg" class="img-fluid" style="border-radius: 90px;">
              <h4 class="card-title">Shraddha Rai</h4>
              <p class="card-text">Itaque illo explicabo voluptatum, saepe libero rerum, ad ducimus voluptas nesciunt debitis numquam.</p>
            </div>
          </div>
    ...
    <div class="row">
     ...
     <?php include('contactform.php'); ?>
      ...
      <div class="col-md-4 text-center">
        ...
        Pune - 411005 <br>
        Phone: +00000000 <br>
        <a href="#" target="_blank">www.omss.com</a> <br>

        <br><br>
        <strong>Jalgaon Branch:</strong> <br>
        OMSS Pvt Ltd, <br>
        Daulat Nagar <br>
        Jalgaon - 425002 <br>
        Phone: +00000000 <br>
    ...
    <div class="container">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6 text-right">
          ...
          <small> Designed by Shraddha &copy; 2020.
          </small>
